...
const App = () => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(Routes, null,
            RouteConfig.map(({ path, component: Component, protected: isProtected, role }, index) => (React.createElement(Route, { key: index, path: path, element: isProtected ? (React.createElement(RouteProtected, { role: role },
